...
health_insurance <- read_csv("data/sahie_2017.csv", skip = 79) %>% 
  ...
  select(area_fips,
         ...
         num_uninsured_below_400_poverty = NUI_5_0,
         num_uninsured_age_50_up = NUI_0_3,
         pct_uninsured_total = PCTUI_0_0,
         pct_uninsured_below_400_poverty = PCTUI_5_0,
...
transportation <- list(air_transport, rail_transport, water_transport, transit_ground_transport, scenic_transport, support_activities_transport, all_industries, county_pops, health_insurance) %>% 
  ...
  select(area_fips,
         ...
         population,
         pct_uninsured_total,
         pct_uninsured_below_400_poverty,
...
health_insurance <- health_insurance %>% 
  ...
  select(area_fips,
         ...
         population,
         num_uninsured_total,
         num_uninsured_below_400_poverty,
...
selected_industries %>% 
  filter(september_jobs_per_thousand_selected_industries >= 250)

# How many of these counties are also among the 100 least-insured in 2017?
